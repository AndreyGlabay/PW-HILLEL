...
export class AddExpenseForm extends BaseForm {
    ...
    private readonly totalCostField = this.page.locator('#addExpenseTotalCost');   
    ...
    public readonly wrongLitersErrorMessage = this.page.locator('.invalid-feedback p', { hasText: 'Liters has to be from 0.01 to 9999' });
